...
\subsubsection{Exitação Harmônica}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width = 0.75\textwidth]{images/figure17:1.png}
...
\subsubsection{Desbalanceamento Rotativo}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width = 0.75\textwidth]{images/figure20:1.png}
        \caption{Relação Relação de Frequências}
    \end{figure} \noindent
...
\subsubsection{Transmisibilidade}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width = 0.75\textwidth]{images/figure22:1.png}
        \caption{Relação Relação de Frequências}
    \end{figure} \noindent
