...
\tikzset{
    ...
    \end{multicols}
        ...
        \subsubsection{Deteção de Erro de \texttt{1 bit}}
            ...
            \paragraph{Aplicação}Adiciona-se um \texttt{bit} em qualquer palavra válida para que o número total de \texttt{bits 1} seja:
                \begin{enumerate}[noitemsep, rightmargin = \leftmargin]
                    \item \textbf{Paridade Par:} Possui um número par de \texttt{bits 1};
                    \item \textbf{Paridade Ímpar:} Possui um número ímpar de \texttt{bits 1};
                \end{enumerate}
        ...
        \subsubsection{Codificação de Hamming \texttt{(15, 11)}}
            ...
            \paragraph{Aplicação}Organize os \texttt{11 bits} de dados sequencialmente nos espaços brancos de uma matriz 4x4 como representado abaixo:
                ...
                \end{table}\noindent
            Na sequência seleciona-se os \textcolor{red!80}{\texttt{bits de paridade}}, apresentados nas posições com \textcolor{red!80}{p}, necessários para que cada \textbf{subgrupo} possuam a mesma paridade como representado abaixo:
                \begin{table}[H]
                    \centering
                ...
                \end{table}\noindent
            Neste ponto pode-se detectar e localizar \texttt{erros de 1 bit}. Na sequência seleciona-se o \textcolor{blue!80}{\texttt{bit de paridade do conjunto}} necessários para que o \textbf{grupo} possuam a mesma paridade como representado abaixo:
                \begin{table}[H]
                    \centering
                    \begin{tabular}{|c|c|c|c|}\hline
