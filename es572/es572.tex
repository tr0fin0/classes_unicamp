...
\end{multicols}
    ...
    \section{Abstração Digital}
        ...
        \subsubsection{Buffer}
            \paragraph{Definição}Dispositivo eletrônico que transfere tensão, visto que ao longo da transmisssão o acumulo de ruídos poderia modificar o sinal transmitido, mantem sua estabilidade apesar de logicamente não alterá-lo.
