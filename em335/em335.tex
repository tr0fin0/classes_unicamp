        ...
        \subsection{Sobremetal}
            ...
            Apesar das definições apresentadas há valores usuais aplicados para diferentes operações e grupos de peças. Desta maneira deve-se considerar as seguintes sugestões:
                \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                    ...
                    \item \textbf{Torneamento:} Considera-se uma qualidade de trabalho de IT6;
                        \begin{table}[H]
                            \centering
                            \begin{tabular}[]{c|c}\hline
                                Diâmetro [mm] & Sobremetal Mínimo [mm]\\\hline
                                ...
                                100 a 180 & 1.2\\\hline
                            \end{tabular}
                            \caption{Sobremetal Torneamento $L/D < 6$}
                        \end{table}\noindent

                    \item \textbf{Retificação Plana:} Considera-se uma qualidade de trabalho de IT4;
                        \begin{table}[H]
                            \centering
                            \begin{tabular}[]{c|c}\hline
                                Diâmetro [mm] & Sobremetal Mínimo [mm]\\\hline
                                ...
                                300 a 500 & 0.2\\\hline
                            \end{tabular}
                            \caption{Sobremetal Retificação}
                        \end{table}\noindent

                    \item \textbf{Retificação Cilíndrica:} Necessário de tabelas separadas;

                    \item \textbf{Shaving:} Processo empregado na fabricação de dentes de engrenagens;
                        \begin{table}[H]
                            \centering
                            \begin{tabular}[]{c|c}\hline
                                Módulo [mm] & Sobremetal Mínimo [mm]\\\hline
                                  12 a 6    & 0.04\\
                                   5 a 4    & 0.035\\
                                3.50 a 2.5  & 0.03\\
                                2.25 a 1.75 & 0.025\\
                                1.50 a 1.4  & 0.015\\
                                1.25 a 0.5  & 0.005\\\hline
                            \end{tabular}
                            \caption{Sobremetal Retificação}
                        \end{table}\noindent
                \end{enumerate}
