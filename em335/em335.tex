...
\newpage
    ...
    \section{Processos Mecânicos de Fabricação}
        ...
        \subsection{Processos de Fundição}
            \paragraph{Definição}Criação de corpos através da solidificação do material no interior de um molde, sendo classificados da seguinte maneira:
                \begin{enumerate}[rightmargin = \leftmargin]
                    \item \textbf{Molde de Areia:} Utilização de areia para criação do molde, geralmente aplicados em pequena escala com as seguintes características:
            
                    \item \textbf{Molde de Casca:} Utilização de uma resina fenólica para criação do molde com as seguintes características:
            
                    \item \textbf{Molde Permanente:} Utilização de metal ou grafite para criação do molde com as seguintes características:
            
                    \item \textbf{Coquilha:} Utilização de metal para criação do molde onde o metal é vazado sob pressão com as seguintes características:
            
                    \item \textbf{Cera Perdida:} Utilização de cera para criação do molde que se desintegra após confecção com as seguintes características:
                \end{enumerate}
