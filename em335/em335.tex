...
\newpage
    ...
    \section{Processos de Fabricação}
        ...
        \subsection{Processo de Usinagem}
            ...
            \paragraph{Sobremetal}Quantidade de material extra necessário para um processo seja aplicado em uma peça, este será \textbf{Ótimo} se assegura a qualidade a um custo acessível. Desta maneira, pode-se estimar o sobremetal ideal, $S_{T}$, através das seguintes equações:
                \begin{equation}
                    \boxed{
                        S_T = 
                        \underbrace{
