...
\newpage
    ...
    \section{Rugosidade}
        ...
        \subsection{Sistema M}
            ...
            Onde:
                \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                    \item $R_{P}$, \textbf{Máximo Pico:} Máxima altura de pico no comprimento amostra entre os $Z_{P_{i}}$ picos;
                    \item $R_{V}$, \textbf{Mínimo Vale:} Mínima altura de vale no comprimento amostra entre os $Z_{V_{i}}$ vales;
                    \item $R_{Z}$, \textbf{Máxima Variação:} Somatório entre os valores absolutos de máximo pico e mínimo vale;
                \end{enumerate}
