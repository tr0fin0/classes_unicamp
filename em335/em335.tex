...
\newpage
    ...
    \section{Processos de Fabricação}
        ...
        \subsection{Processo de Usinagem}
            \paragraph{Definição}Aplicação de forças com remoção de material do corpo, superando a tensão de ruptura $\sigma_{r}$ com grande flexibilidade produtiva. Nestes procedimentos são utilizados os seguintes conceitos:
                \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
