        ...
        \subsection{Processo de Usinagem}
            ...
            Onde:
                \begin{enumerate}[rightmargin = \leftmargin]
                    ...
                    \item $t_{i-1}$, \textbf{Profundidade Danificada:} Representa a profundidade danificada na operação anterior;

                    \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                        \item \texttt{Aplicação}:
                            \begin{equation}
                                t_{i-1} = 
                                \begin{cases}
                    ...
                    Note que na prática pode-se analisar o parâmetro $R_{\text{max}_{i-1}} + t_{i-1}$ conjuntamente, realizando as seguintes aproximações
