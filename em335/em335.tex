...
\newpage
    ...
    \section{Transferência de Cotas}
        ...
        \subsection{Referências}
            \paragraph{Definição}Face de uma peça a partir da qual as medições serão representadas, utilizando cotas definidas a partir das seguintes partes do mecanismo:
                \begin{enumerate}[noitemsep]
