...
\newpage
    ...
    \section{Geração de Calor em Sólido}
        ...
        \subsubsection{Resistência Térmica do Conjunto de Aletas}
            \begin{definition}
                \begin{equation}
                    R_{\text{t,o}} = 
                    \frac{\theta_{b}}{q_{t}} = 
                    \frac{1}{\rho_{0}h A_{t}}
                \end{equation}
            \end{definition}

        \subsubsection{Fator de Forma}
            \begin{definition}
                Considera-se Condução e Taxa de Condução de Calor Adimensional.
                    \begin{equation}
                        q = S K \Delta T_{1-2}
                    \end{equation}
                Tabela 4.5 Incropera.
                    \begin{equation}
                        R_{\text{t, cond}} = \frac{1}{S K}
                    \end{equation}
                Forma Adimensional:
                    \begin{equation}
                        q*_{re} = \frac{q L_{c}}{K A_{S}(T_{1} - T_{2})}
                    \end{equation}
                Onde:
                    \begin{equation}
                        L_{C} = 
