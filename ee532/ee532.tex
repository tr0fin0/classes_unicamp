            ...
            Assim, define-se as possíveis organizações como:
                \begin{enumerate}[rightmargin = \leftmargin]
                    ...
                    \item \textbf{Base Comum:} Base ligada ao negativo, Coletor como saída e Emissor como entrada, como representado pelo circuito abaixo:;
                        ...
                        \end{figure}
                \end{enumerate}
            Apesar das configurações apresentadas desempenharem como esperado para amplificadores ainda haverá vulnerabilidade do sistema a alterações das cargas que influenciam o ganho, e consequentemente, o funcionamento do circuito. Afim de proteger os amplificadores implementam-se os seguintes circuitos:
                \begin{enumerate}[rightmargin = \leftmargin]
