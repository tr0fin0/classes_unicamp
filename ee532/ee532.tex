...
\newpage
    ...
    \section{Aplicação Transistor Bipolar de Junção}
        ...
        \subsection{Amplificadores}
            \paragraph{Definição}Circuito que potencializa o sinal de saída com base no sinal de entrada a partir de uma relação entre os demais componentes que o constituem, estes podem ser construídos com transistores em diferentes configurações:
                \begin{table}[H]
                    \centering
