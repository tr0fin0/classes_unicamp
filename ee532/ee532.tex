...
\newpage
    ...
    \section{Diodo}
        ...
        \subsection{Modelagem}
            \paragraph{Definição}Conhecida o comportamento e estrutura dos diodos será necessário definir modelos adequados as aplicações empregadas. Desta maneira, utilizam-se as seguinte aproximações para seu funcionamento:
