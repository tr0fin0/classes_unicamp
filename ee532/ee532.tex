...
\newpage
    ...
    \section{Transistor Bipolar de Junção}
        \paragraph{Definição}Dispositivo elétrico capaz de controlar uma corrente de saída através de uma tensão na entrada. Este será obtido através da combinação em série de diodos classificados de acordo com as ligações realizados, sendo representados a seguir:
