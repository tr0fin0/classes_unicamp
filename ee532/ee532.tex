...
\newpage
    ...
    \section{Diodo Zener}
        \paragraph{Definição}Quando diretamente polarizado este apresentará o mesmo funcionamento de um diodo comum, entretanto quando inversamente polarizado , representado pelo seguinte circuito:
            \begin{figure}[H]
                \centering
                \begin{circuitikz}
