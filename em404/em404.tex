            ...
            \paragraph{Planos Paralelos}Quando o movimento ocorrer ao longo de planos paralelos com $\omega_{x} = \omega_{y} = 0$ e $\omega_{z} \ne 0$ as equações serão:
                \begin{equation}
                    \boxed{
                        ...
                        \Sigma\vec{M}_{z} = 
                        \begin{cases}
                            \Sigma\vec{M}_{x} = (- I_{xz}\dot{\omega}_{z} + I_{yz}\dot{\omega}_{z}^{2})\vec{i}\\
                            \Sigma\vec{M}_{y} = (- I_{yz}\dot{\omega}_{z} - I_{xz}\dot{\omega}_{z}^{2})\vec{j}\\
                            \Sigma\vec{M}_{z} = (+ I_{zz}\dot{\omega}_{z}^{2})\vec{k}\\
                        \end{cases}
                    }
                \end{equation}
            Onde:
