                ...
                \begin{enumerate}[noitemsep]
                    \item \textbf{Velocidade:} Diferenciando o espaço com $\vec{r} = r \vec{e_{r}}$:
                        \begin{equation}
                            ...
                            \hspace{20mm}
                            \boxed{
                                \vec{v} = \dot{\vec{r}} = \dot{r}\vec{e_{r}} + r\dot{\theta}\vec{e_{\theta}}
                            }
                        \end{equation}
...
\newpage
    ...
    \section{Cinemática}
        \subsection{Movimento Retilíneo}
            \paragraph{Definição}Caso geral do movimento de uma partícula ao longo de uma linha reta, onde sua posição em qualquer instante $t$ poderá ser determinada por sua distância $s$ a partir de um referêncial fixo $O$ sobre a linha, sendo descritos pelas seguintes equações:
                \begin{enumerate}[noitemsep]
                    \item \textbf{Coordenadas Retangulares:}
                        \begin{enumerate}[noitemsep]
                            \item \texttt{Velocidade Média:}
                                \begin{equation}
                                    \boxed{
                            ...
                            \item \texttt{Velocidade Instantânea:}
                                \begin{equation}
                                    \boxed{
                                        v = \lim_{\Delta\to 0} \frac{\Delta s}{\Delta t} = \diff{s}{t} =\dot{s}
                                    }
                                \end{equation}
                            \item \texttt{Aceleração Média:}
                                \begin{equation}
                                    \boxed{
                            ...
                            \item \texttt{Aceleração Instantânea:}
                                \begin{equation}
                                    \boxed{
                                        a = \lim_{\Delta\to 0} \frac{\Delta v}{\Delta t} = \diff{v}{t} =\dot{v} = \ddot{s}
                                    }
                                \end{equation}
                        \end{enumerate}
                \end{enumerate}
