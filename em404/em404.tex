    ...
    \section{Cinética Plana de Corpos Rígidos}
            ...
            \paragraph{Definição}Propriedade constante relacionada a geometria do corpo rígido estudado, quantificando a resistência à variação na velocidade de rotação em torno do eixo $z$ a partir do centro de gravidade obtido pela seguinte equação:
                ...
                \begin{figure}[H]
                    ...
                    \begin{subfigure}[t]{0.45\textwidth}
                        ...
                        \caption{Definição do Momento de Inércia}
                    \end{subfigure}
                    \begin{subfigure}[t]{0.45\textwidth}
                        \centering
                        \includegraphics[height = 4cm]{ima5.png}
                        \caption{Definição em Ponto Arbitrário}
                    \end{subfigure}
        ...
        \subsection{Equações Gerais}
            \paragraph{Definição}Nesta abordagem retoma-se os resultados obtidos para cinética de sistemas de partículas, aplicando-os para o centro de gravidade um corpo rígido genérico com os seguintes resultados:
                ...
                \end{equation}
            Quando considera-se o momento de inércia a quantidade de movimento angular, obtendo as seguintes equações para centro de gravidade do corpo rígido:
                \begin{equation}
                    \boxed{
                        \Sigma\vec{F} = m\vec{\overline{a}}
                    }
                ...
                \end{equation}
            Quando considera-se um ponto arbitrário a quantidade de movimento angular obtêm-se as seguintes equações que podem ser aplicadas tanto para movimento relativo quanto para corpos interligados:
                \begin{equation}
                    \boxed{
