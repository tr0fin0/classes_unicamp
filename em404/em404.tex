...
\newpage
    ...
    \section{Cinética}
        ...
        \subsection{Aplicação de Trabalho e Energia}
            ...
            Onde:
                \begin{enumerate}[noitemsep]
                    \item \textbf{Trabalho Força Elástica:} Considerando esta força, obtém-se a seguinte equação:
                        \[
                            \boxed{
                        ...
                        \]
                    \item \textbf{Trabalho Força Gravitacional:} Considerando esta força, obtém-se a seguinte equação:
                        \[
                            \boxed{
                                U_{1-2} = \int_{1}^{2} \vec{F} \cdot d\vec{r}
