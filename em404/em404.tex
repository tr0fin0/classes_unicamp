...
\newpage
    ...
    \section{Cinética Plana de Corpos Rígidos}
        ...
        \subsection{Equações Gerais}
            \paragraph{Definição}Nesta abordagem retoma-se os resultados obtidos para cinética de sistemas de partículas, aplicando-os para um corpo rígido genérico com os seguintes resultados:
                \begin{equation}
                    \boxed{
