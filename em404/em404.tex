...
\newpage
    ...
    \section{Cinética de Sistemas de Partículas}
        ...
        \subsection{Trabalho e Energia}
            ...
            \paragraph{Conservação}Caso nenhum trabalho seja realizado sobre um sistema conservativo, então nenhuma energia será dissipada, \textbf{Lei de Conservação de Energia Dinâmica}, implicando:
                \begin{equation}
                    \boxed{
                        T_{1} + V_{1} = T_{2} + V_{2}
                    }
        ...
        \subsection{Impulso e Quantidade de Movimento Linear}
            ...
            \paragraph{Conservação}Caso as forças externas resultantes sobre um sistema de massas seja nula, então nenhuma quantidade de movimento linear será dissipada, \textbf{Princípio da Conservação da Quantidade de Movimento Linear}, implicando:
                \begin{equation}
                    \boxed{
                        \vec{G}_{1} = \vec{G}_{2}
                    }
                ...
                \begin{enumerate}[rightmargin = \leftmargin]
                    ...
                    Considerando referências absolutos obtêm-se:
                        \begin{equation}
                            ...
                            \boxed{
                                \sum\vec{M}_{O} = 
                                \vec{\dot{H}}_{G} = 
                                \sum\rho_{i}\times m_{i}\vec{\ddot{r}}_{i} = 
                                \sum\rho_{i}\times\vec{F}_{i}
                            }
                        \end{equation}
                    ...
                    \item \textbf{Ponto Arbitrário:} Somatório dos momentos das quantidades de movimento linear em torno de um ponto arbitrário $P$ que pode apresentar movimento, descritos pelas seguintes equações:
                        \begin{equation}
                            \boxed{
                                \vec{H}_{P} = 
                                \sum(\overline{\rho} + \rho_{i})\times m_{i}\vec{\dot{r}}_{i} = 
                                \vec{H}_{G} + \overline{\rho}\times m_{i}\vec{\overline{v}}_{i}
                            }
                            \hspace{10mm}
                            \boxed{
                                \sum\vec{M}_{P} = \vec{\dot{H}}_{G} + \overline{\rho}\times m \vec{\overline{a}}
                            }
                        \end{equation}
                \end{enumerate}

            \paragraph{Conservação}Caso o momento resultante de todas as forças de um sistema de massas em torno de um ponto fixo for nulo, então nenhuma quantidade de movimento angular será dissipada, \textbf{Princípio da Conservação da Quantidade de Movimento Angular}, implicando:
                \begin{equation}
                    \boxed{
