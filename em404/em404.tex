    ...
    \section{Cinética}
        ...
        \subsection{Aplicação de Impulso e Quantidade de Movimento}
            \paragraph{Definição}Quando uma partícula se desloca com velocidade constante haverá uma quantidade de movimento, sendo descrito pela seguinte equação:
                ...
                \end{equation}
            Assim, pelo \textbf{Princípio do Impulso}, a quantidade de movimento linear total de uma partícula enquanto se move do ponto 1 para o ponto 2 será igual ao impulso aplicado, formalmente descrito pela seguinte equação:
                \begin{equation}
                    \boxed{
