...
\newpage
    ...
    \section{Cinética de Sistemas de Partículas}
        ...
        \subsection{Escoamento em Regime Permanente}
            \paragraph{Definição}Quantidade de massa fluidindo a uma taxa constante ao longo de um recipiente, ou superfície, podendo possuir diversas entradas e saídas, sendo descrito pela seguinte equação:
                \begin{equation}
                    \boxed{
