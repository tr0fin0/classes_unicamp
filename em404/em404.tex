                    ...
                    \item \textbf{Ponto Arbitrário:} Neste ponto, tanto para movimento relativo quanto para corpos interligados, o momento de inércia a quantidade de movimento angular são obtidos pelas seguintes equações:
                        \begin{equation}
                            ...
                            \boxed{
                                ...
                                \Sigma\overline{I}\alpha + \Sigma m\overline{a}d
                            }
                        \end{equation}

                    \item \textbf{Eixo Fixo:} Neste ponto o momento de inércia a quantidade de movimento angular são obtidos pelas seguintes equações:
                        \begin{equation}
                            \boxed{
                                \Sigma\vec{F} = \Sigma m\vec{\overline{a}}
                            }
                            ...
                            \boxed{
                                \overline{I}_{O} = 
                                \overline{I} + \Sigma m\overline{r}^{2}
                            }
                        \end{equation}
