...
\newpage
    ...
    \section{Coordenadas}
        ...
        \subsection{Coordenadas Polares}
            \paragraph{Definição}Decomposição vetorial das variáveis envolvidas no movimento da partícula a uma distância radial $r$, medida a partir de um ponto fixo $O(a,b)$, e por um ângulo $\theta$ da linha radial, onde os sentidos são descritos a seguir:
                \begin{enumerate}[noitemsep]
