        ...
        \subsection{Movimento Relativo com Rotação de Eixos}
            ...
            Onde:
                \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                    ...
                    Onde:
                        \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                            \item \texttt{Velocidade Relativa:} Representa o vetor de velocidade de $A$ com relação a $B$, representado pela seguinte equação:
                                \begin{equation}
                                    \boxed{
                    ...
                    Onde:
                        \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                            \item \texttt{Aceleração Relativa Tangencial:} Representa o vetor de aceleração de $A$ com relação a $B$ tangencial a trajetória considerada a partir do \textbf{Centro de Velocidade Nula}, representado pela seguinte equação:
                                \begin{equation}
                                    \boxed{
                            ...
                            \item \texttt{Aceleração Relativa Normal:} Representa o vetor de aceleração de $A$ com relação a $B$ normal a trajetória considerada a partir do \textbf{Centro de Velocidade Nula}, representado pela seguinte equação:
                                \begin{equation}
                                    \boxed{
