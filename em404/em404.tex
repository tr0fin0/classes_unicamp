                ...
                \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                    ...
                    Onde:
                        \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                            ...
                            \item \texttt{Aceleração de Coriolis:} Aceleração causada pela rotação percebida apenas por observadores no sistema rotativo; 
                                \begin{equation}
                                    \boxed{
...
\newpage
    ...
    \section{Cinética Plana de Corpos Rígidos}
        ...
        \subsection{Trabalho e Energia}
            ...
            Onde:
                \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                    \item $T_{i}$, \textbf{Energia Cinética:} Analisa-se conjuntamento a parcela gerada pela translação e pela rotação, obtendo:
                        \begin{equation}
                            \boxed{
