...
\newpage
    ...
    \section{Mecânica Analítica}
        ...
        \subsection{Coordenadas Generalizadas}
            \paragraph{Definição}Conjunto de coordenadas que possam ser aplicadas como referência para descrição do movimento dos corpos envolvidos no movimento, obedecendo as seguintes imposições:
                \begin{enumerate}[noitemsep]
