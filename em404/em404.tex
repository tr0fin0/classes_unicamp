...
\newpage
    ...
    \section{Cinética de Sistemas de Partículas}
        ...
        \subsection{Impulso e Quantidade de Movimento Linear}
            ...
            \paragraph{Conservação}Caso as forças externas resultantes sobre um sistema de massas seja nula, então nenhuma quantidade de movimento será dissipada, \textbf{Princípio da Conservação da Quantidade de Movimento Linear}, implicando:
                \begin{equation}
                    \boxed{
                        \vec{G}_{1} = \vec{G}_{2}
                    }
