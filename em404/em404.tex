...
\newpage
    ...
    \section{Cinemática}
        ...
        \subsection{Movimento Relativo}
            \paragraph{Definição}Caso geral do movimento medido a partir da combinação entre referências movéis e referências absolutas de uma partícula no espaço, sendo descrito pelas seguintes equações: 
\newpage
