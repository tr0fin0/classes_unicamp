        ...
        \subsection{Equações de Lagrange}
            ...
            Onde:
                \begin{enumerate}[rightmargin = \leftmargin, noitemsep]
                    ...
                    \item $L$: \textbf{Lagrangiano:} Representa o balanço de energia em um sistema, onde $T$ virá da Equação \ref{eq.KyneticEnergy} e $V$ virá da Equação \ref{eq.PotencialEnergy};
                    ...
                    \item $Q_{NC}$: \textbf{Forças não Conservativas:} Representa forças não conservativas do sistema, ação de forças externas;
                \end{enumerate}
\end{document}