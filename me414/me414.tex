...
\newpage
    ...
    \section{Variáveis Aleatórias}
        ...
        \subsection{Mediana}
            \paragraph{Definição}Representa a divisão de uma variável aleatória em dois conjuntos de igual probabilidade de ocorre, ou seja, atende a seguinte equação:
                \begin{equation}
                    \boxed{
