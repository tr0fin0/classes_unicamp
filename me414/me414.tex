    ...
    \section{Inferência}
        ...
        \subsection{Intervalo de Confiança}
            ...
            Nota-se que esta função apresentará máximo, isto é, o pior resultado possível para o intervalo de confiança, com $p = \frac{1}{2}$ e portanto $p(1-p) = \frac{1}{4}$ desta maneira o cálculo se reduz para a seguinte expressão:
                ...
                \end{equation}
            Além dos resultados acima, aplicáveis para proporções, pode-se estender sua aplicação para variáveis que apresentem média amostral $\bar{X}$ então as aproximações pelo \textbf{Teorema do Limite Central} serão válidos.
\end{document}