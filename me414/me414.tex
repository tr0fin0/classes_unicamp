...
\newpage
    ...
    \section{Distribuição Amostral}
        ...
        apresentar diferentes modelagens para sua descrição das quais as principais são listadas a seguir:
            \begin{enumerate}[rightmargin = \leftmargin]
        ...
        Note que independente do modelo aplicado quando uma amostra $n$ for retirada as propriedades desta são obtidas através das seguintes equações:
            \begin{equation}
                ...
                \qquad
                \boxed{
                    EP(\overline{X}) = \sqrt{V(\overline{X})}
                }
            \end{equation}
            \begin{equation}
                \boxed{
