...
\newpage
    ...
    \section{Distribuição Amostral}
        \paragraph{Definição}Descrição do comportamento de uma população através da aproximação das características de uma amostra retirada aleatoriamente, que pode ser apresentar diferentes modelagens para sua descrição das quais as principais são listadas a seguir:
            \begin{enumerate}[rightmargin = \leftmargin]
