...
\newpage
    ...
    \section{Ferramentas de Análise}
        \subsection{Histograma}
            \paragraph{Definição}Representação gráfica de uma variável contínua agrupada em intervalos, abertos em uma extremidade e fechados na outra, regulares de acordo com as frequências dos dados, construídos como mostrado no exemplo a seguir:
