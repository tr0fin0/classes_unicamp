...
\newpage
    ...
    \section{Variáveis Aleatórias Contínuas}
        ...
        \subsection{Modelo Normal}
            \paragraph{Definição}Quando uma variável aleatória contínua assume uma distribuição normal dos valores, isto é, dependendo de sua média e variância, sendo descrita pela seguinte equação:
                \begin{equation}
                    \boxed{
                        f_{X}(x) = 
