    ...
    \section{Hipótese}
        \paragraph{Definição}Afirmações sobre um parâmetro de uma população que deverá ser testado. Desta maneira, será necessário estabelecer procedimentos a serem seguidos como explicados abaixo:
            \begin{enumerate}[rightmargin = \leftmargin]
                ...
                \item \textbf{Estatísticas:} Comparação entre os valores encontradas na população após experimentação e os esperados pela \textbf{Hipótese};

                \item \textbf{p-valor:} Probabilidade que resume a possibilidade de que a \texttt{Hipótese Nula} seja verdadeira;
