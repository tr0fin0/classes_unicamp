...
[XCL, YCL]  = ssFree_expm(t0,X0,A0,C0);
[XCF, YCF]  = ssForced_expm(t0,A0,B0,C0,D0, u);
...
[XAL, YAL]  = ssFree_eig(t0,X0,A0,C0);
[XAF, YAF]  = ssForced_eig(t0,A0,B0,C0,D0, u);
...
[XLL, YLL]  = ssFree_laplace(t0,X0,A0,C0);
[XLF, YLF]  = ssForced_laplace(t0,A0,B0,C0,D0, u);
...
[XPL, YPL]  = ssFree_poly(t0,X0,A0,C0);
[XPF, YPF]  = ssForced_poly(t0,A0,B0,C0,D0, u);
