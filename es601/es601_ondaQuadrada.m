...
%%============================================================================
%%  Considerações
%   Define-se a Onda Quadrada como uma Função Par, isto é, simétrica com
%   relação ao eixo y.
%        ___     
%       |   |    
%       |   |   
...
for k = -N:1:N
    ...
    % Note que a função sinc trazida pelo Matlab já apresenta pi em seu
    % cálculo logo esta constante não é incluida.
end
...
%   Nota-se que a definição do Matlab apresenta uma onda que se inicia no
%   zero.
