...
\begin{multicols}{2}
    ...
    \subsection{Teste}
        \paragraph{TESTE}\blindtext\blindtext

    \raggedcolumns
    \columnbreak

    \subsection{Teste}
        \paragraph{TESTE}\blindtext\blindtext\blindtext
...
\end{multicols}
    \paragraph{Definição}\blindtext\blindtext\blindtext
